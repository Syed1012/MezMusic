...
const NewPlayer = () => {
  return (
    <div class="fixed bottom-0 left-1/2 transform -translate-x-1/2 flex justify-center w-full p-7">
      <div class="w-2/3">
        {/* Main Container Edit */}
        <div class="bg-black h-55 text-white opacity-75 border-slate-100 dark:bg-slate-800 dark:border-slate-500 border-b rounded-t-xl p-4 pb-6 sm:p-10 sm:pb-8 lg:p-6 xl:p-10 xl:pb-8 space-y-6 sm:space-y-8 lg:space-y-6 xl:space-y-8 items-center">
        ...
        {/* Second Main Container (Buttons) Edit */}
        <div class="opacity-75 bg-black text-white rounded-b-xl flex items-center">
