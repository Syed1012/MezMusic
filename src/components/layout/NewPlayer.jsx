  ...
  return (
    <div className="fixed bottom-0 left-1/2 transform -translate-x-1/2 flex justify-center w-full p-2 ">
      <div className="w-2/3">
        ...
        <div className="opacity-75 bg-black text-white rounded-b-xl flex items-center">
          ...
          <button
            type="button"
            className="text-white flex-none -my-2 mx-auto w-15 h-20 rounded-full ring-1 ring-slate-900/5 shadow-md flex items-center justify-center"
            aria-label="Pause"
          >
